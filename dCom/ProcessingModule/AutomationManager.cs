...
namespace ProcessingModule
{
    ...
    public class AutomationManager : IAutomationManager, IDisposable
    {
        ...
        private void AutomationWorker_DoWork()
        {
            ...
            PointIdentifier Capacity = new PointIdentifier(PointType.ANALOG_OUTPUT, 4400);
            PointIdentifier FirstPowerSwitch = new PointIdentifier(PointType.DIGITAL_OUTPUT, 3600);
            PointIdentifier SecondPowerSwitch = new PointIdentifier(PointType.DIGITAL_OUTPUT, 3601);
            PointIdentifier USB1 = new PointIdentifier(PointType.DIGITAL_OUTPUT, 3000);
            PointIdentifier USB2 = new PointIdentifier(PointType.DIGITAL_OUTPUT, 3001);
            PointIdentifier USB3 = new PointIdentifier(PointType.DIGITAL_OUTPUT, 3002);
            List<PointIdentifier> list = new List<PointIdentifier> { Capacity, FirstPowerSwitch, SecondPowerSwitch, USB1, USB2, USB3 };
            while (!disposedValue)
            {
                ...
                if (points[1].RawValue == 0)
                {
                    ...
                    if (value < points[0].ConfigItem.HighLimit)
                        processingManager.ExecuteWriteCommand(points[0].ConfigItem, configuration.GetTransactionId(),
                            configuration.UnitAddress, Capacity.Address, value);
                    else
                        processingManager.ExecuteWriteCommand(points[1].ConfigItem, configuration.GetTransactionId(),
                            configuration.UnitAddress, FirstPowerSwitch.Address, 1);
                }
                ...
                if (points[2].RawValue == 1)
                {
                    ...
                    if (value > points[0].ConfigItem.LowLimit)
                        processingManager.ExecuteWriteCommand(points[0].ConfigItem, configuration.GetTransactionId(), configuration.UnitAddress, Capacity.Address, value);
                    else
                        processingManager.ExecuteWriteCommand(points[2].ConfigItem, configuration.GetTransactionId(), configuration.UnitAddress, USB1.Address, 0);
                }
                ...
                if (points[3].RawValue == 1)
                {
                    ...
                    if (value > points[0].ConfigItem.LowLimit)
                        ...
                        processingManager.ExecuteWriteCommand(points[3].ConfigItem, configuration.GetTransactionId(), configuration.UnitAddress, USB2.Address, 0);
                }
                ...
                if (points[4].RawValue == 1)
                {
                    ...
                    if (value > points[0].ConfigItem.LowLimit)
                        ...
                        processingManager.ExecuteWriteCommand(points[3].ConfigItem, configuration.GetTransactionId(), configuration.UnitAddress, USB3.Address, 0);
